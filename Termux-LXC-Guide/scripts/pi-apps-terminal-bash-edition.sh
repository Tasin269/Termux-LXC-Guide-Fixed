...
if [[ ! -f "/usr/local/bin/pi-apps" && ! -d "$HOME/pi-apps" ]];
then
...
function help() {
	...
	echo -e "${white}${dark_grey_background}list [-d|--description]${white}${normal}${white} - print all apps available in pi-apps.\n"
	echo -e "${white}${dark_grey_background}list-i [-d|--description]${normal}${white} - print all installed apps.\n"
	echo -e "${white}${dark_grey_background}list-u [-d|--description]${normal}${white} - print all uninstalled apps.\n"
	echo -e "${white}${dark_grey_background}list-c [-d|--description]${normal}${white} - print all apps failed to install/uninstall (are corrupted).\n"
...
# launch pi-apps regularly if no (known) arguments provided
exit $?
